...
sbatch_sh = "#!/usr/bin/env bash\n" + '\n'.join([f'sbatch --partition=All --output=./benchmarks/slurm_runs/{run_name}/slurm-%j.out ./benchmarks/linux_start_slurm_run.sh {run_name} $1 $2 $3 $4' for run_name in run_starts])
