...
class Base_GP(object):
    ...
    def monitor_performance(self, mode=''):
        ...
        if self.monitor['gen_fitness_avg'] == 'y':
            if mode == 'update':  # save value to final list and reset counter
                ...
                self.printpl('m', 'Average Fitness: ')
            elif mode == 'reset':
                pass
    ...
    def data_load_origin_tree(self, origin_tree_file_path):
        ...
        self.origin_fitness_train = self.tree_fitness_train()
    ...
    def branch_root_build(self, old_node_type):
        ...
        if self.pop_node_arity == 1:  # 1 child
            ...
            print('\n\t\033[31m ERROR! In branch_root_build: pop_node_arity =', self.pop_node_arity, '\033[0;0m'); self.fx_karoo_pause()  # consider special instructions for this (pause)
    ...
    def pop_pareto_front(self):
        ...
        for candidate in self.gene_pool:
            parsimony = self.population_new[candidate][TR_parsimony][1]
