...
def gp_run(plagih_root, load_backup, config_path, out_dir, force_new_run, eval_action, path_data, cooltree_origin, kernel_name, analyze, tf_device_log, pop_size):
    """
    ...
    gp = ExplainableGP(plagih_root, root_dir, config, eval_action, kernel_name=kernel_name, path_data=path_data, tf_device_log=tf_device_log, pop_size=pop_size)
