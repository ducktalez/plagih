...
class TestIB(unittest.TestCase):
    ...
    def all_states(self, env):
        array = [env.state['o'][0], env.state['o'][1], env.state['o'][2], env.state['o'][3], env.state['o'][4], env.state['o'][5], env.state['o'][6], env.state['o'][7], env.state['o'][8],
                 env.state['o'][9],
                 env.state['coc'], env.state['hg'], env.state['hv'], env.state['he'], env.state['gs_domain'],
                 env.state['gs_sys_response'], env.state['gs_phi_idx'], env.state['ge'], env.state['ve'], env.state['MC'],
                 env.state['c'], env.state['p'], env.state['v'], env.state['g'], env.state['h'], env.state['f'], env.state['fb'], env.state['oc'], env.state['reward']]
        return array
