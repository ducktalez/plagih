...
**Neu hier? Schau dir die [Setup-Anleitung (SETUP_GUIDE.md)](SETUP_GUIDE.md) an!**

Kurz:
```bash
# Mit Python Virtual Environment (empfohlen)
python3 -m venv venv
...
- complex ifte-optimier..s.f.
- Ist es üblich, einen "Wert aus t-x/vorherige Entscheidung" als input zu haben?
