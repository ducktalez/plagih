...
class ExplainableGP(object):
    ...
    def __init__(self, config_dict, file_dict, gp_ops_distribution_list, monitor_dict):
        ...
        self.pareto_hash_dict = {}              # the best tree for each distance value -> {distance: tree_meta_tuple}
    ...
    def data_pickle_save(self):
        ...
        run_data = {'gen_id': self.gen_id,
                    ...
                    'pareto_front': self.pareto_hash_dict,
    ...
    def monitor_performance_generation(self, gene_pool_hash_dict):
        ...
        if len(gene_pool_hash_dict) > 0:
            self.printpl('i', 'The generation has:', len(gene_pool_hash_dict), '')
    ...
    def pop_pareto_update(self, gene_pool_hash_dict):
        ...
        for tree_id, tree_hash in gene_pool_hash_dict.items():
            ...
            if parsim in self.pareto_hash_dict:
                cmp_fitness = self.hash_tree_meta[self.pareto_hash_dict[parsim]]['fitness_train']
                if (self.fitness_type == 'max' and fitness_train > cmp_fitness) or \
                        (self.fitness_type == 'min' and fitness_train < cmp_fitness):

                    self.printpl('v', 'Found new tree with parsimony', parsim, 'and fitness', fitness_train, '. Old one was:', cmp_fitness)
                    #
                    ...
                    self.pareto_hash_dict[parsim] = gene_pool_hash_dict[tree_id]
    ...
    def gp_selection_tournament(self, tourn_size):
        ...
        for n in range(tourn_size):
            ...
            tree_id = 1 + np.random.randint(len(self.gene_pool)+1)
    ...
    def gen_finalize(self):
        ...
        self.pop_pareto_update(gene_pool_hash_dict)
    ...
    def eval_tf_ast_expr(self, expr, tensors):
        ...
        """
        # print('Current expr:', expr)  # importantprint for dbgging
