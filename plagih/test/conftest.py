...
def _get_tree_classes():
    ...
    from plagih.trees import (
        ...
        sympy_to_tree, tree_simplification, eval_parsimony,
        BaseOperator, ChainableOp, ExprCondPair_Dummy,
        MathOperator, LogicOperator, RelationalOperator, Trigonometry,
        OperatorArity, NodeDummy, NodeWithChilds
    )
    return locals()
...
def basic_operator_dict():
    ...
    from plagih.trees import (Add, Mul, Div, Sub, Abs, Sign, Square, Sqrt,
                               Sin, Cos, Min, Max, Lt, Le, And, Or, Not)
    return {
        Add: 2, Mul: 2, Div: 1, Sub: 1,
        Abs: 1, Sign: 1, Square: 1, Sqrt: 0.5,
        Sin: 0.5, Cos: 0.5,
        Min: 1, Max: 1,
        Lt: 1, Le: 1, And: 1, Or: 1, Not: 1
    }
...
def full_operator_dict():
    ...
    from plagih.trees import (Add, Mul, Div, Sub, Pow, PowRounded, Sqrt, Square,
                               Abs, Sign, Log, Exp, Sin, Cos, Tan, Asin, Acos, Atan,
                               Tanh, Sinh, Cosh, Min, Max, Lt, Le, Gt, Ge, Eq, Ne,
                               And, Or, Xor, Not, Ifte, Round)
    return {
        Add: 2, Mul: 2, Div: 1, Sub: 1,
        Pow: 0.5, PowRounded: 0.5, Sqrt: 0.5, Square: 1,
        Abs: 1, Sign: 1, Log: 0.3, Exp: 0.3,
        Sin: 0.5, Cos: 0.5, Tan: 0.2,
        Asin: 0.2, Acos: 0.2, Atan: 0.2,
        Tanh: 0.3, Sinh: 0.2, Cosh: 0.2,
        Min: 1, Max: 1,
        Lt: 1, Le: 1, Gt: 0.5, Ge: 0.5, Eq: 0.5, Ne: 0.5,
        And: 1, Or: 1, Xor: 0.5, Not: 1,
        Ifte: 1, Round: 0.5
    }
...
def cartpole_evolution():
    ...
    from plagih.trees import (Evolution, Add, Mul, Div, Sub, Abs, Sign, Square, Sqrt,
                               Sin, Cos, Min, Max, Lt, Le, And, Or, Not)
    operator_dict = {
        Add: 2, Mul: 2, Div: 1, Sub: 1,
        Abs: 1, Sign: 1, Square: 1, Sqrt: 0.5,
...
def simple_tree():
    ...
    from plagih.trees import Add, Symbol, Number
...
def complex_tree():
    ...
    from plagih.trees import Sin, Add, Mul, Symbol, Number
...
def boolean_tree():
    ...
    from plagih.trees import And, Lt, Symbol, Number, Boolean
    return And(
...
def ifte_tree():
    ...
    from plagih.trees import Ifte, Lt, Symbol, Number
    return Ifte(
...
def cartpole_tree():
    ...
    from plagih.trees import Add, Mul, Symbol, Number
    return Add(
...
def get_all_terminal_classes():
    ...
    from plagih.trees import Number, Symbol, Boolean
